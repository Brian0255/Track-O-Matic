...
namespace TrackOMatic
{
    ...
    {
        private static readonly List<OffsetInfoEntry> OFFSETS_OLD = new()
        {
        ...
        private static readonly List<OffsetInfoEntry> OFFSETS_NEW = new()
        {
            new OffsetInfoEntry(ItemName.PROGRESSIVE_SLAM_1, 0x7FC9AF,8,1),
            new OffsetInfoEntry(ItemName.PROGRESSIVE_SLAM_2, 0x7FC9AF,8,2),
            new OffsetInfoEntry(ItemName.PROGRESSIVE_SLAM_3, 0x7FC9AF,8,3),

            new OffsetInfoEntry(ItemName.FAIRY_CAMERA, 0x18, 8, 8, true),
            new OffsetInfoEntry(ItemName.SHOCKWAVE, 0x18, 8, 4, true),

            new OffsetInfoEntry(ItemName.DONKEY, 0x0B, 8, 1, true),
            new OffsetInfoEntry(ItemName.DIDDY, 0x0B, 8, 2, true),
            new OffsetInfoEntry(ItemName.LANKY, 0x0B, 8, 4, true),
            new OffsetInfoEntry(ItemName.TINY, 0x0B, 8, 8, true),
            new OffsetInfoEntry(ItemName.CHUNKY, 0x0B, 8, 16, true),
            ...
            new OffsetInfoEntry(ItemName.KEY_1, 0xA, 8, 1, true),
            new OffsetInfoEntry(ItemName.KEY_2, 0xA, 8, 2, true),
            new OffsetInfoEntry(ItemName.KEY_3, 0xA, 8, 4, true),
            new OffsetInfoEntry(ItemName.KEY_4, 0xA, 8, 8, true),
            new OffsetInfoEntry(ItemName.KEY_5, 0xA, 8, 16, true),
            new OffsetInfoEntry(ItemName.KEY_6, 0xA, 8, 32, true),
            new OffsetInfoEntry(ItemName.KEY_7, 0xA, 8, 64, true),
            new OffsetInfoEntry(ItemName.KEY_8, 0xA, 8, 128, true),

            new OffsetInfoEntry(ItemName.BEAN, 0xD, 8, 32, true),

            new OffsetInfoEntry(ItemName.NINTENDO_COIN, 0xD, 8, 128, true),
            new OffsetInfoEntry(ItemName.RAREWARE_COIN, 0xD, 8, 64, true),

            new OffsetInfoEntry(ItemName.DIVING, 0x18, 8, 128, true),
            ...
            new OffsetInfoEntry(ItemName.CROWN_TOTAL, 0xC, 8, 0, true),
            new OffsetInfoEntry(ItemName.MEDAL_TOTAL, 0xE, 8, 0, true),
            new OffsetInfoEntry(ItemName.PEARL_TOTAL, 0xF, 8, 0, true),
            new OffsetInfoEntry(ItemName.FAIRY_TOTAL, 0x10, 8, 0, true),
            new OffsetInfoEntry(ItemName.RAINBOW_COIN_TOTAL, 0x11, 8, 0, true),
        ...
        public static bool useNewOffsets = false;
        public static IList<OffsetInfoEntry> OFFSETS => useNewOffsets ? OFFSETS_NEW : OFFSETS_OLD;
    }
}
