...
namespace TrackOMatic
{
    public static class HintMove
    {
        ...
        public static readonly IReadOnlyList<HintNameEntry> All = typeof(HintMove)
        .GetFields(BindingFlags.Public | BindingFlags.Static)
        .Where(f => f.FieldType == typeof(HintNameEntry))
        .Select(f => (HintNameEntry)f.GetValue(null))
        .ToList();

        public static readonly IReadOnlyDictionary<string, HintNameEntry> ByFieldName = typeof(HintMove)
        .GetFields(BindingFlags.Public | BindingFlags.Static)
        .Where(f => f.FieldType == typeof(HintNameEntry))
